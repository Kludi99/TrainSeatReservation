...
namespace TrainSeatReservation.Data.Migrations
{
    ...
    [Migration("20210830100209_AddSeatsAndDictionaryEntities")]
    partial class AddSeatsAndDictionaryEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainSeatReservation.EntityFramework.Models.Carriage", b =>
                {
                    b.HasOne("TrainSeatReservation.EntityFramework.Models.Dictionary", "CarriageClass")
                        .WithMany()
                        .HasForeignKey("CarriageClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TrainSeatReservation.EntityFramework.Models.Dictionary", "Type")
                        .WithMany()
