...
namespace TrainSeatReservation.Areas.Administration.Controllers
{
    ...
    public class CarriageController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Number,Name,Type")] CarriageDto carriage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Number,Name,Type")] CarriageDto carriage)
        {
            if (id != carriage.Id)
            {
                return NotFound();
